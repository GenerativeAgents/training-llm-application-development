# 【AIエージェント開発者養成講座 基礎コース】で使用するサービスの事前準備のお願い

講座内で次のサービスを使用します。これらのサービスが利用できるよう、事前に次の準備をお願いいたします。

|     | サービス名        | 講座での利用内容                                                                                                                                                                                                                                 | 実施いただく事前準備<br />（後述） |
| --- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- |
| ①   | GitHub            | 見本となるソースコードの共有で使います。                                                                                                                                                                                                         | 1. 社内申請<br />2. 接続確認       |
| ②   | 弊社講座用サイト  | 小テストやアンケートで使用します。                                                                                                                                                                                                               | 1. 社内申請<br />2. 接続確認       |
| ③   | ハンズオン環境    | ブラウザで利用できる VSCode の環境です。                                                                                                                                                                                                         | 1. 社内申請<br />2. 接続確認       |
