...
```console
curl -sSfLO https://raw.githubusercontent.com/GenerativeAgents/training-llm-application-development/refs/heads/main/setup/ec2_code_server.yaml
...
aws ssm start-session --target "${instance_id}" \
  ...
  --parameters command="sudo -u ubuntu git -C /home/ubuntu/environment/training-llm-application-development pull"
```
...
curl -sSfLO https://raw.githubusercontent.com/GenerativeAgents/training-llm-application-development/refs/heads/main/setup/update_cloudfront_origin.sh
